export interface Piece {
    position: string;
    type: string;
    color: boolean; // True is white, false is black
    id: number;

      


    move(newPosition: string, board): boolean;
...
export class Pawn implements Piece{
    ...
    constructor(position: string, type: string, color: boolean, id: number) 
    {
